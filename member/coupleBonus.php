...
var thArray  = Array(
    ...
    '<?php echo $translations['M03706'][$language]; /* C/F Left DVP  */ ?>',
    '<?php echo $translations['M03707'][$language]; /* New DVP  */ ?>',
    '<?php echo $translations['M03708'][$language]; /* Remaining DVP  */ ?>',
    '<?php echo $translations['M03709'][$language]; /* C/F Right DVP  */ ?>',
    '<?php echo $translations['M03707'][$language]; /* New DVP  */ ?>',
    '<?php echo $translations['M03708'][$language]; /* Remaining DVP  */ ?>',
    '<?php echo $translations['M03710'][$language]; /* No. of Couple  */ ?>',
    '<?php echo $translations['M03711'][$language]; /* Calculated Couple  */ ?>',
        ...
        if (list){
            $.each(list, function(k, v){
                var rebuildData = {
                    ...
                    cfLeftDVP       : numberThousand(v['cfLeftDVP'],2),
                    newLeftDVP      : numberThousand(v['newLeftDVP'],2),
                    remLeftDVP      : numberThousand(v['remLeftDVP'],2),
                    cfRightDVP      : numberThousand(v['cfRightDVP'],2),
                    newRightDVP     : numberThousand(v['newRightDVP'],2),
                    remRightDVP     : numberThousand(v['remRightDVP'],2),
                    coupleNum       : numberThousand(v['coupleNum'],2),
                    calCouple       : numberThousand(v['calCouple'],2),
