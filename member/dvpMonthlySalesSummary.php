            ...
            <div class="row align-items-end">
                ...
                <div class="col-lg-4 col-md-6 col-12 form-group">
                    ...
                    <select id="rank" class="form-control formDesign" dataName="memberRank" dataType="select">
                        ...
                        <option value="1">
                            <?php echo $translations["M03719"][$language]; /* Fiz Member */ ?>
                        </option>
                        <option value="2">
                            <?php echo $translations["M03723"][$language]; /* Fiz Preneur */ ?>
                        </option>
                        <option value="3">
                            <?php echo $translations["M03308"][$language]; /* Fiz Executive */ ?>
                        </option>
                        <option value="4">
                            <?php echo $translations["M03720"][$language]; /* Fiz Manager */ ?>
                        </option>
                        <option value="5">
...
var thArray  = Array(
        ...
        '<?php echo $translations['M03433'][$language]; /* From Member ID */ ?>',
        '<?php echo $translations['M03732'][$language]; /* From Full Name */ ?>',
        '<?php echo $translations['M03432'][$language]; /* From Member Rank */ ?>',
...
function pagingCallBack(pageNumber, fCallback){
    ...
    var formData = {
        command             : "getDVPMonthlySalesSummary",
        ...
        if (list){
            $.each(list, function(k, v){
                var rebuildData = {
                    ...
                    totalDVP        : numberThousand(v['totalDVP'],2)
                };
