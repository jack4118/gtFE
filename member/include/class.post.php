<?php
    ...
    class post{
        function curl($command, $params = array(), $site="Member", $language="english", $source="Web", $sourceVersion="", $userAgent="") {
            ...
            $dataArray = array("command"        => $command,
                               ...
                               "ip"             => $ip,
                               "params"         => $params,
                               "marcaje"        => $marcajeData['marcaje'],
                               "marcajeTK"      => $marcajeData['marcajeTK']
                               );
