	    	...
	    	<form id="searchDIV" class="filter">
		        <div class="row align-items-end">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 form-group">
                        <label><?php echo $translations['M02593'][$language] /*From Member*/ ?></label>
                        <input type="text" id="fromMemberID" dataName="fromMemberID" dataType="text" class="form-control">
                    </div>
                    <div class="col-lg-4 col-md-6 col-12 form-group">
                        <label><?php echo $translations['M02566'][$language] /*Generation*/ ?></label>
                        <input type="text" id="generation" dataName="generation" dataType="text" class="form-control">
                    </div>
...
var thArray  = Array(
    ...
    '<?php echo $translations['M02566'][$language]; /* Generation */ ?>',
    '<?php echo $translations['M03431'][$language]; /* From Amount (PV) */ ?>',
    '<?php echo $translations['M03031'][$language]; /* Percentage */ ?>',
    '<?php echo $translations['M03430'][$language]; /* Commision Value (CV) */ ?>',
    '<?php echo $translations['M03429'][$language]; /* CV Rate */ ?>',
        ...
        if (list){
            $.each(list, function(k, v){
                var rebuildData = {
                    ...
                    generation      : v['fromLevel'],  
                    bonusValue      : addCommas(Number(v['fromAmount']).toFixed(2)),  
                    percentage      : addCommas(Number(v['percentage']).toFixed(2)),
                    payableAmount   : addCommas(Number(v['payableAmount']).toFixed(2)),
                    cvRate          : addCommas(Number(v['cv_rate']).toFixed(2)),
                    bonusPayout     : addCommas(Number(v['payableAmountRP']).toFixed(2))
                };
