...
<section class="pageContent loginPagePadding">
    <div class="pageTitle">
        <span id="creditType"></span><?php echo $translations['M03123'][$language]; /* MetaFiz Star Program */?>
    </div>
    <div class="mt-4">
        <div class="row">
            <div class="col-md-4">
                    ...
                    <div class="col-lg-4 col-md-12 p-4">
                        ...
                        <div class="${blueBox} p-4">
                            <div class="row justify-content-between">
                                ...
                                <p class="pr-2 font-weight-bold">${totalSalesSymbol} ${v['totalSales'] == "-"?v['totalSales']:numberThousand(v['totalSales'],2)}</p>
                            </div>
                            <div class="row justify-content-between">
                            ...
                            <div class="row justify-content-between">
                                ...
                                <p class="pr-2 font-weight-bold">${v['perc']}${percSymbol}</p>
                            </div>
                        </div>
                    </div>
                    `;
