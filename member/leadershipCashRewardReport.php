...
<section class="pageContent loginPagePadding">
    <div class="pageTitle">
        <?php echo $translations['M03718'][$language]; // Leadership Cash Reward Bonus ?>
    </div>
    <div class="mt-4">
...
var thArray  = Array(
        ...
        '<?php echo $translations['M03717'][$language]; /* Accumulated Couple */ ?>',
        ...
        if (list){
            $.each(list, function(k, v){
                var rebuildData = {
                    ...
                    rank 	            : v['rank'],
                    accCouple 	        : addCommas(v['accCouple'])  ,
