            ...
            <div class="col-12">
                <div class="login-signup-card row mx-0">
                    <div class="col-md-6 pb-5 pb-md-0">
                        ...
                        <div class="row mt-4">
                            <div class="col">
                                <button id="loginBtn2" class="btn button-red" data-lang="M03853">
...
<script>
    ...
    $(document).ready(function(){
        ...
        var bypassLoading   = 0;
        var fCallback = "";
        var adminID        = "<?php echo $_SESSION['POST'][$postAryName]['adminID']; ?>";
        var adminSession   = "<?php echo $_SESSION['POST'][$postAryName]['adminSession']; ?>";
        ...
        $('#loginBtn2').click(function(){
            ...
            username = $('#dialingArea option:selected').val() + phone;
