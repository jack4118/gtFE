...
<?php include("head.php"); ?>
    ...
    <script>
        ...
        var id = "<?php echo $_POST['packageID']; ?>";
        ...
        $(document).ready(function() {
            ...
            $('#submitBtn').click(function() {
                ...
                if(editFlag == 1){
                    var formData  = {
                        command         : 'editStarterPackageDetail', 
                        packageID       : id,
                        name            : name,
                        code            : code,
                        // catalogue       : catalogue,
        ...
        function loadDefaultListing(data, message) {
            ...
            $("#totalWeight").val(numberThousand(data.packageDetails.weight,3));
                                ...
                                <div class="col-sm-9 col-xs-12">
                                    <div class="buildChargesQuantityBox">
                                        <div class="chargesQuantityBox" getCountryID="${v['id']}">
                                            <div class="row">
                                                <div class="col-sm-6 col-xs-12">
                                                    Retail Price (${v['currencyCode']}) <input type="text" class="form-control limitNum price retailPriceInput priceSetting" onkeyup="calcMemberPrice(this, 'retailPrice')"  value="${v['price']}">
                                                </div>
                                                <div class="col-sm-6 col-xs-12">
                                                    Promotion Price (${v['currencyCode']}) <input type="text" class="form-control limitNum promoPrice promoPriceInput priceSetting" onkeyup="calcMemberPrice(this, 'promoPrice')"  value="${v['promoPrice']}">
                                                </div>
        ...
        function uploadVideoSuccess() {
            showMessage("Edit Package Success.", 'success', 'Congratulations!', 'upload', 'getStarterPackageList.php');
        }
