    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#addPackage').click(function() {
                $.redirect("addStarterPackageDetails.php");
            });
            ...
            $('#seeAllBtn').click(function() {
                ...
                var formData   = {
                    command     : "getStarterPackageListing",
            ...
            $('#exportBtn').click(function () {
                ...
                var formData = {
                    command: "getStarterPackageListing",
                    filename: "StarterPackageListingReport",
                    searchData: searchData,
                    header: thArray,
                    key: key,
                    DataKey: "packageList",
        ...
        function editRecord(packageID) {
            $.redirect('editStarterPackageDetails.php', {
                packageID : packageID
            });
        }
