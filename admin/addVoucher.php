                                ...
                                <div class="col-xs-12">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 col-xs-12">
                                            ...
                                            <input id="discCode" type="text" class="form-control">
                                            <span id="voucherCodeError" class="errorSpan text-danger"></span>
                                        </div>

                                        <div class="col-sm-4 col-xs-12">
                                            <label>Quantity</label>
                                            <input id="discQty" type="text" class="form-control">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#submitBtn').click(function(){
                ...
                var discountPercentage = $('#disPercentageInp').val(); //2nd if
                var discountMaxAmount = $('#maxDiscAmtInp').val(); //2nd if
                var discountAmount = $('#discAmtInp').val(); //2nd if
                var formData  = {
                command: 'addDiscountVoucherSetting',
                ...
                fCallback = successAddVoucherDis;
                ajaxSend(url, formData, method, fCallback, debug, bypassBlocking, bypassLoading, 0);
            })
        });
                ...
                $.each(packageList.normal,function(k,v){
                    buildNormalPkg += `
                        <div class="col-xs-4" style="margin:10px 0px">
                            <input type="checkbox" name="${v['packageID']}" class="voucherCheckbox" id="${v['packageID']}" >
        ...
        function successAddVoucherDis(data,message){
            showMessage(message,'success','Add Discount Voucher','success','discountVoucherSetting.php');
        }
