...
<?php include("head.php"); ?>
                        ...
                        <div class="col-lg-12">
                            <div class="card-box p-b-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                    <div class="col-lg-12">
                        <div id="currentDetails" class="card-box" style="background: rgb(245, 245, 245); padding: 20px 25px;">
    ...
    <script>
        ...
        $(document).ready(function() {
            var formData = {
                command: "checkStarterpackEmailAttachment",
            ...
            $('#submitBtn').click(function() {
                ...
                formData  = {
                    command: 'addStarterpackEmailAttachment', 
                    subject : subject, 
        ...
        function submitCallback(data, message) {
            if(data){
                ...
                $.each(data.data, function (lang, val) {
                    var reqData2 = new FormData();
                    if(val.upload_name){
                        var base64Data = reqData['english']['attachmentData'];
                        ...
                        reqData2.append('attachment', val['upload_name']);
                    }
                ...
                var uploadName = data.data[0].upload_name;

                submitCallback2(uploadName);
            }
        }

        function submitCallback2(uploadName) {
                var name = $('#subject').val();
                var path = tempMediaUrl + uploadName;

                formData  = {
                    command: 'updateStarterpackEmailAttachment', 
                    name : uploadName, 
                    path: path,
                    contenttype : "pdf"
                };
                var fCallback = successUpload;
                ajaxSend(url, formData, method, fCallback, debug, bypassBlocking, bypassLoading, 0);
        }
        ...
        function successUpload() {
            showMessage('<?php echo $translations['A00411'][$language]; /* Successful added document. */?>', 'success', '<?php echo $translations['A00412'][$language]; /* Add Document */?>', 'upload', 'updateStarterpackEmailAttachment.php');
        }
        ...
        function loadDefaultListing(data, message) {
            ...
            $('#currentDetails').html(currentDetails);    
