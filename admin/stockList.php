    ...
    function loadDefaultListing(data, message) {
        ...
        if (data.stockList != "" && data.stockList.length > 0) {
            ...
            $.each(data.stockList, function(k, v) {
                var viewBtn = `
                    <a data-toggle="tooltip" title="" onclick="viewBatch('${v['product_id']}', '${v['name']}', '${v['vendor']}', '${v['barcode']}')" class="btn btn-icon waves-effect waves-light btn-primary" data-original-title="View" aria-describedby=""><i class="fa fa-list"></i></a>
                `;
