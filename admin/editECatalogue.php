...
<?php include("head.php"); ?>
                                                ...
                                                <div class="tab-content b-0 m-b-0 p-t-0">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div id="addLanguageDiv" class="col-md-4">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if(!id) {
                var message  = 'E-Catalogue does not exist';
                showMessage(message, '', 'Error', 'exclamation-triangle', 'document.php');
                return;
            }

            formData  = {command : 'getECatalogue', id : id};
            ...
            $('#backBtn').click(function() {
                $.redirect('getECatalogueList.php');
            });
            ...
            $('#submitBtn').click(function() {
                ...
                formData  = {
                    command: 'editECatalogue', 
                    documentID: "<?php echo $_POST['id']; ?>",
                    subject : subject, 
                ...
                $.each(data, function (lang, val) {
                    ...
                    if(val.attachement) {
                        if(val.attachement.uploadName){
                            ...
                            reqData2.append('attachment', val['attachement']['uploadName']);
                        }
                    }
        ...
        function uploadVideoSuccess() {
            showMessage('Successful updated E-Catalogue.', 'success', 'Edit E-Catalogue', 'edit', 'getECatalogueList.php');
        }
                ...
                var wrapper = `
                    <div class="col-md-12">
                        <div class="popupMemoImageWrapper ${defaultClass}">
                            ...
                            <input type="hidden" id="storeAttachmentSize${wrapperLength}" value="${obj.attachement_name}">
                            ...
                            <input type="file" id="attachmentUpload${wrapperLength}" class="hide" accept='application/pdf' onchange="displayAttachmentName('${wrapperLength}', this)">
