                                            ...
                                            <div class="tab-content b-0 m-b-0 p-t-0">
                                                ...
                                                <div class="form-group row mx-0">
                                                    <div class="col-md-5">
                                                        ...
                                                        <input id="page" type="text" class="form-control" required/>
                                                ...
                                                <div class="form-group row mx-0">
                                                    <div class="col-md-5">
                                                        ...
                                                        <div id="treeType" class="m-b-20">
                                                            ...
                                                            <div class="radio radio-inline">
                                                                <input id="sponsorRadio" type="radio" value="public" name="typeRadio" checked/>
...
<script>
    ...
    $(document).ready(function() {
        ...
        if(!id) {
            ...
            showMessage(message, '', 'Error', 'exclamation-triangle', 'getBannerList.php');
            return;
        }
    ...
    function uploadVideoSuccess() {
        showMessage('Successful edit banner', 'success', 'Congratulations', 'upload', 'getBannerList.php');
    }
