...
<html>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <!-- <div class="card-box p-b-0"> -->
                                <div id="addProdAttribute" class="btn btn-primary waves-effect waves-light m-b-20">
                                    Add Attribute
                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#addProdAttribute').click(function() {
                $.redirect("addAttribute.php");
            });
        ...
        function loadDefaultListing(data, message) {
            ...
            if(list) {
                ...
                $.each(list, function(k, v) {
                    ...
                    var attribute_value = '';
                    $.each(v['value_name'], function(key, val) {
                        attribute_value += val + '<br>';
                    });

                    var rebuildData = {
                        attr_name     : v['name'],
                        attr_val_name : attribute_value,
                        buildBtn      : buildBtn
                    };
        ...
        function editRecord(id) {
            $.redirect('editAttribute.php', {id : id});
        }
