                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form id="searchPortfolio" role="form">
                                            ...
                                            <div class="col-sm-4 form-group">
                                                ...
                                                <select id="leaderUsername" class="form-control" dataName="leaderUsername" dataType="text">
...
<script>
    ...
    var url2           = 'scripts/reqLeader.php';

    $(document).ready(function() {

        var formData  = {
            command   : "getLeaderSettingListByType",
            type : "czoRate"
        };
        var fCallback = leaderUsernameDetails;
    ...
    function leaderUsernameDetails (data, message) {
       // console.log(data);
       var leaderUsernameList = data.leaderUsernameList;
        if(leaderUsernameList) {
                $.each(leaderUsernameList, function(key) {
                    $('#leaderUsername').append('<option value="'+leaderUsernameList[key]['leader_id']+'" name="'+leaderUsernameList[key]['leader_id']+'">'+leaderUsernameList[key]['username']+'</option>');
        });
      }
    }
</script>
