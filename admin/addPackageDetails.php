                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="row">
                                            <div class="col-xs-12" style="margin-top: 20px">
                                                ...
                                                <input id="pvPrice" type="text" class="form-control limitNum">
    ...
    //         }
       //  }
        ...
        function uploadVideoSuccess() {
            showMessage("Add Package Success.", 'success', 'Congratulations!', 'upload', 'getPackageList.php');
        }
