                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box p-b-0">
                            <h4 class="header-title m-t-0 m-b-30"><?php echo $translations['A00998'][$language]; /* Role Details */ ?></h4>
                            <div class="row">
                                <div class="col-md-6">
                    ...
                    <div class="col-md-12 m-b-20">
                        ...
                        <button id="addNewRole" type="submit" class="btn btn-primary waves-effect waves-light"><?php echo $translations['A00361'][$language]; /* Add */ ?></button>
                    </div>
                </div>
                <!-- end row -->
...
<script>
        ...
        $('#addNewRole').click(function() {
            ...
            if(validate) {
                ...
                var formData = {
                    ...
                    status      : status,
                    site        : "Admin" //add from admin site confirm will be admin
                };
    ...
    function sendNew(data, message) {
        showMessage('New role successfully created.', 'success', 'Add new role', 'search', 'adminRolesList.php');
    }
</script>
</body>
</html>