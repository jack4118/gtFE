                                            ...
                                            <form id="searchForm" role="form">
                                              <div class="col-sm-12 px-0">
                                                ...
                                                <div class="col-sm-4 form-group">
                                                    ...
                                                    <input id="time" type="text" class="form-control" dataName="time" oninput="this.value = this.value.replace(/[^0-9]/g, '');" dataType="text">
                                                </div>
                                                ...
                                                <div class="col-sm-4 form-group">
                                                    ...
                                                    <input id="instruction" type="text" class="form-control" dataName="instruction" dataType="text">
                                                </div>
                                                ...
                                                <div class="col-sm-4 form-group">
                                                    ...
                                                    <input id="url" type="text" class="form-control" dataName="url" dataType="text">
                                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#addProduct').click(function() {
                $.redirect("addCookingSuggest.php");
            });
        ...
        function editRecord(id) {
            $.redirect('editCookingSuggest.php', {
                id : id
            });
        }
