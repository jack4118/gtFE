                                              ...
                                              <div class="col-sm-12 px-0">
                                                ...
                                                <div class="col-sm-4 form-group">
                                                    ...
                                                    <span class="pull-right hide">
                                                        <input id="fmatch" type="radio" class="usernameType" name="fromUsernameType" value="match" checked> 
                                                        <label for="fmatch" style="margin-right: 15px;">Match</label>

                                                        <input id="flike" type="radio" class="usernameType" name="fromUsernameType" value="like" style="margin-left: 15px;" > 
