function buildPlacementTree(sponsor, downlines, treeDiv, placementChildNumber) {
    ...
    $(".hv-item").append('<div class="hv-item-parent"><p><span style="color:#565681">'+sponsor['name']+'<br>'+sponsor['member_id']+'</span><br>Left DVP : '+addCommas(Number(sponsor['DVP_1']).toFixed(2))+'<br>Right DVP : '+addCommas(Number(sponsor['DVP_2']).toFixed(2))+'<br>Remaining Left DVP : '+addCommas(Number(sponsor['remainingDVP_1']).toFixed(2))+'<br>Remaining Right DVP : '+addCommas(Number(sponsor['remainingDVP_2']).toFixed(2))+'<br>Join Date : '+sponsor['created_at']+'</p></div>');
...
function recursiveBuildPlacementTwoChild(downlines, uplineID, leftDownline, rightDownline, leftFlag, rightFlag) {
    if(leftFlag) {
        ...
        if(leftChildFlag || rightChildFlag) {
            ...
            $("#child"+leftDownline['client_id']).append('<div class="hv-item-parent"><p id="'+leftDownline['client_id']+'" onclick="treeBranchClick(this)"><span style="color:#565681">'+leftDownline['name']+'<br>'+leftDownline['member_id']+'</span><br>Left DVP : '+addCommas(Number(leftDownline['DVP_1']).toFixed(2))+'<br>Right DVP : '+addCommas(Number(leftDownline['DVP_2']).toFixed(2))+'<br>Remaining Left DVP : '+addCommas(Number(leftDownline['remainingDVP_1']).toFixed(2))+'<br>Remaining Right DVP : '+addCommas(Number(leftDownline['remainingDVP_2']).toFixed(2))+'<br>Join Date : '+leftDownline['created_at']+'</p></div>');
            ...
            $("#children"+uplineID).append('<div class="hv-item-child"><p id="'+leftDownline['client_id']+'" onclick="treeBranchClick(this)"><span style="color:#565681">'+leftDownline['name']+'<br>'+leftDownline['member_id']+'</span><br>Left DVP : '+addCommas(Number(leftDownline['DVP_1']).toFixed(2))+'<br>Right DVP : '+addCommas(Number(leftDownline['DVP_2']).toFixed(2))+'<br>Remaining Left DVP : '+addCommas(Number(leftDownline['remainingDVP_1']).toFixed(2))+'<br>Remaining Right DVP : '+addCommas(Number(leftDownline['remainingDVP_2']).toFixed(2))+'<br>Join Date : '+leftDownline['created_at']+'</p></div>');
        }
    }
    else {
    ...
    if(rightFlag) {
        ...
        if(leftChildFlag || rightChildFlag) {
            ...
            $("#child"+rightDownline['client_id']).append('<div class="hv-item-parent"><p id="'+rightDownline['client_id']+'" onclick="treeBranchClick(this)"><span style="color:#565681">'+rightDownline['name']+'<br>'+rightDownline['member_id']+'</span><br>Left DVP : '+addCommas(Number(rightDownline['DVP_1']).toFixed(2))+'<br>Right DVP : '+addCommas(Number(rightDownline['DVP_2']).toFixed(2))+'<br>Remaining Left DVP : '+addCommas(Number(rightDownline['remainingDVP_1']).toFixed(2))+'<br>Remaining Right DVP : '+addCommas(Number(rightDownline['remainingDVP_2']).toFixed(2))+'<br>Join Date : '+rightDownline['created_at']+'<br></p></div>');
            ...
            $("#children"+uplineID).append('<div class="hv-item-child"><p id="'+rightDownline['client_id']+'" onclick="treeBranchClick(this)"><span style="color:#565681">'+rightDownline['name']+'<br>'+rightDownline['member_id']+'</span><br>Left DVP : '+addCommas(Number(rightDownline['DVP_1']).toFixed(2))+'<br>Right DVP : '+addCommas(Number(rightDownline['DVP_2']).toFixed(2))+'<br>Remaining Left DVP : '+addCommas(Number(rightDownline['remainingDVP_1']).toFixed(2))+'<br>Remaining Right DVP : '+addCommas(Number(rightDownline['remainingDVP_2']).toFixed(2))+'<br>Join Date : '+rightDownline['created_at']+'</p></div>');
        }
    }
    else {
        $("#children"+uplineID).append('<div class="hv-item-child"><p>Empty</p></div>');
...
function recursiveBuildPlacementThreeChild(downlines, uplineID, leftDownline, middleDownline, rightDownline, leftFlag, middleFlag, rightFlag) {
    if(leftFlag) {
        ...
        if(leftChildFlag || middleChildFlag || rightChildFlag) {
            $("#children"+uplineID).append('<div id="child'+leftDownline['client_id']+'" class="hv-item-child"></div>');
            $("#child"+leftDownline['client_id']).append('<div class="hv-item-parent"><p id="'+leftDownline['client_id']+'" onclick="treeBranchClick(this)"><span style="color:#565681">'+leftDownline['name']+'<br>'+leftDownline['member_id']+'</span><br>Left DVP : '+addCommas(Number(leftDownline['DVP_1']).toFixed(2))+'<br>Right DVP : '+addCommas(Number(leftDownline['DVP_2']).toFixed(2))+'<br>Remaining Left DVP : '+addCommas(Number(leftDownline['remainingDVP_1']).toFixed(2))+'<br>Remaining Right DVP : '+addCommas(Number(leftDownline['remainingDVP_2']).toFixed(2))+'<br>Join Date : '+leftDownline['created_at']+'<br></p></div>');
            $("#child"+leftDownline['client_id']).append('<div id="children'+leftDownline['client_id']+'" class="hv-item-children"></div>');
    ...
    if(middleFlag) {
        ...
        if(leftChildFlag || middleChildFlag || rightChildFlag) {
            ...
            $("#child"+middleDownline['client_id']).append('<div class="hv-item-parent"><p id="'+middleDownline['client_id']+'" onclick="treeBranchClick(this)"><span style="color:#565681">'+middleDownline['name']+'<br>'+middleDownline['member_id']+'</span><br>Left DVP : '+addCommas(Number(middleDownline['DVP_1']).toFixed(2))+'<br>Right DVP : '+addCommas(Number(middleDownline['DVP_2']).toFixed(2))+'<br>Remaining Left DVP : '+addCommas(Number(middleDownline['remainingDVP_1']).toFixed(2))+'<br>Remaining Right DVP : '+addCommas(Number(middleDownline['remainingDVP_2']).toFixed(2))+'<br>Join Date : '+middleDownline['created_at']+'<br></p></div>');
            ...
            $("#children"+uplineID).append('<div class="hv-item-child"><p id="'+middleDownline['client_id']+'" onclick="treeBranchClick(this)"><span style="color:#565681">'+middleDownline['name']+'<br>'+middleDownline['member_id']+'</span><br>Left DVP : '+addCommas(Number(middleDownline['DVP_1']).toFixed(2))+'<br>Right DVP : '+addCommas(Number(middleDownline['DVP_2']).toFixed(2))+'<br>Remaining Left DVP : '+addCommas(Number(middleDownline['remainingDVP_1']).toFixed(2))+'<br>Remaining Right DVP : '+addCommas(Number(middleDownline['remainingDVP_2']).toFixed(2))+'<br>Join Date : '+middleDownline['created_at']+'</p></div>');
        }
    }
    else {
        $("#children"+uplineID).append('<div class="hv-item-child"><p>Empty</p></div>');
...
function buildSponsorTree(sponsor, downlines, treeDiv, scrollFlag) {
    if(scrollFlag == 1) {
        ...
        //Append items to diagram
        $(".hv-item").append('<br/><div class="hv-item-parent"><p><span style="color:#565681">'+sponsor['username']+'</span><br>My Principle : '+addCommas(Number(sponsor['ownSales']).toFixed(8))+'<br>Total Downline’s Principle : '+addCommas(Number(sponsor['groupSales']).toFixed(8))+'<br></p></div>');
        $(".hv-item").append('<div class="hv-item-children"></div>');

        if(downlines.length > 0) {
            $.each(downlines, function(key, val) {
                $(".hv-item-children").append('<div class="hv-item-child"><p id="'+downlines[key]['client_id']+'" onclick="treeBranchClick(this)"><span style="color:#565681">'+downlines[key]['username']+'</span><br>My Principle : '+addCommas(Number(downlines[key]['ownSales']).toFixed(8))+'<br>Total Downline’s Principle : '+addCommas(Number(downlines[key]['groupSales']).toFixed(8))+'</p></div>');
            });
        }
        else {
