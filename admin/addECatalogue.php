...
<?php include("head.php"); ?>
                                                            ...
                                                            <div id="appendImage">
                                                                <div class="col-md-12">
                                                                    <div class="popupMemoImageWrapper default">
                                                                        ...
                                                                        <input type="file" id="attachmentUpload1" class="hide" accept='application/pdf' onchange="displayAttachmentName('1', this)">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            formData  = {command: 'getECatalogue'};
        ...
        function successUpload() {
            showMessage('Successful added E-Catalogue.', 'success', 'Add E-Catalogue', 'upload', 'getECatalogueList.php');
        }
