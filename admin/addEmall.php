            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                                                ...
                                                <div class="tab-content b-0 m-b-0 p-t-0">
                                                    ...
                                                    <div class="form-group row mx-0">
                                                        <div class="col-md-5">
                                                            ...
                                                            <input id="carat" type="text" class="form-control" required></textarea>
                                                    ...
                                                    <div class="form-group row mx-0">
                                                        <div class="col-md-5">
                                                            ...
                                                            <input id="cost" type="text" class="form-control" required></textarea>
                                                    ...
                                                    <div class="form-group row mx-0">
                                                        <div class="col-md-5">
                                                            ...
                                                            <input id="amount" type="text" class="form-control" required></textarea>
                                                                ...
                                                                <div id="appendImage">
                                                                    <div class="col-md-4">
                                                                        <div class="popupEmallImageWrapper default">
                                                                            ...
                                                                            <input type="file" id="fileUpload1" class="hide" accept="image/*" onchange="displayFileName('1', this)">
                                                                            <div>
                                                                                <a href="javascript:;" onclick="$('#fileUpload1').click()" class="btn btn-primary btnUpload"><?php echo $translations["M01350"][$language]?></a>
                                                                                <span id="fileName1" class="fileName"><?php echo $translations["A01399"][$language]?></span>
                        ...
                        <form style="display:none" id="myUpload" name="form" method="post" target="" action="" enctype="multipart/form-data" >
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#submitBtn').click(function() {
                ...
                if(checkVideoSize > maxByte){
                    ...
                    processButton("submitBtn",false,"<?php echo $translations['A00323'][$language]; /* Submit */?>");
                    return false;
                }
                ...
                ajaxSend('scripts/reqEmall.php', formData, method, fCallback, debug, bypassBlocking, bypassLoading, 0,'submitBtn',"<?php echo $translations['A00323'][$language]; /* Submit */?>");
        ...
        function submitCallback(data, message) {
            if(data){
                ...
                var files = $('#uploadVideo')[0].files[0];
                var formData = new FormData();
                formData.append('file', files);
                formData.append('videoName', $("[name = 'videoName']").val());
                formData.append('previousVideoName', $("[name = 'previousVideoName']").val());
