                            ...
                            <div class="card-box p-b-0">
                                <div class="row">
                                    <div class="form-group">
                                        <label>
                                            <?php echo $translations['A00882'][$language]; /* Name */?> :
                                        </label>
                                        <span id="name"></span>
                                    </div>
                                    <div class="form-group">
                                        <label>
                                            <?php echo $translations['A00883'][$language]; /* Username */?> :
                                        </label>
                                        ...
                                        <form role="form" id="newWithdrawal" data-parsley-validate novalidate>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="country" class="form-control">
                                                    <option value="">
                                                        <?php echo $translations['A00913'][$language]; /* Please select a Country */?>
                                                    </option>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span id="bankError" class="customError text-danger"></span>
                                            </div>
                                            <div class="form-group">
                                                <span>
                                                    <?php echo $translations['A00915'][$language]; /* Branch */?>
                                                </span>
                                                <input id="branch" type="text" name="Account" class="form-control">
                                                <span id="branchError" class="customError text-danger"></span>
                                            </div>
                                            <div class="form-group">
                                                <span>
                                                    <?php echo $translations['A00609'][$language]; /* Account No */?>
                                                </span>
                                                <input id="accountNo" type="text" name="Account" class="form-control">
                                                <span id="accountNoError" class="customError text-danger"></span>
                                            </div>
                                        </form>
                                        <div class="btn">
...
<script>
        ...
        function redirect() {
            showMessage('<?php echo $translations['A00918'][$language]; /* Withdrawal request submitted successfully */?>', 'success', '<?php echo $translations['A00919'][$language]; /* Credit Withdrawal */?>', 'list-ul', ['memberWithdrawal.php?type=' + creditType, {creditType : creditType, id : id, fullName : fullName, username : username} ]);
        }
