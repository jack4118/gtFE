...
<script>
    ...
    $(document).ready(function() {
        ...
        formData  = {command: 'getCoinSwapAdminCharges'};
        ...
        $('#editBtn').click(function() {
            ...
            if(validate) {
                ...
                var formData = {
                    'command'    : 'updateSwapCoinAdminFee',
    ...
    function sendEdit(data, message) {
        showMessage('<?php echo $translations['A00684'][$language]; /* Successful added unit price */?>', 'success', 'Swap Coin Admin Fee', '', 'swapCoinFee.php');
    }
