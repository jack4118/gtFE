                                        ...
                                        <form id="searchForm" role="form">
                                            ...
                                            <div class="col-sm-12 px-0">
                                                ...
                                                <!-- <div class="col-sm-4 form-group">
                                                    ...
                                                    <input type="text" class="form-control" dataName="fromEamil" dataType="text">
                                                </div> -->
                                                <div class="col-sm-4 form-group">
                                                    <label class="control-label">
                                                        Rank
                                            ...
                                            <div class="col-sm-12 px-0">
                                                <div class="col-sm-4 form-group">
                                                    ...
                                                    <select class="form-control" dataName="fromRankID" dataType="select">
                                                        <option value="">All</option>
                                                        <?php foreach($_SESSION["rankList"] as $value){ ?>
                                                            <option value="<?php echo $value['id']; ?>"><?php echo $value['display']; ?></option>
                                                        <?php } ?>
                                                ...
                                                <div class="col-sm-4 form-group">
                                                    ...
                                                    <input type="text" class="form-control" dataName="generation" dataType="text" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');">
                                                </div>
                                            </div>
                                        </form>
                                        <!-- hidden -->
    ...
    function loadDefaultListing(data, message) {
        ...
        if (data.bonusList) {
            ...
            $.each(data.bonusList, function (k, v) {
                var rebuildData = {
                    ...
                    // unitPrice: addCormer(v['unitPrice']),
                    percentage: v['percentage'],
                    payableAmount: addCormer(v['payableAmount']),
                    cv_rate: v['cv_rate'],
                    payableAmountRP: addCormer(v['payableAmountRP'])
                };
        ...
        if(data.grandTotal) {
            $('#' + tableId).find('tbody').append(`
                <tr style="">
                    <td colspan='13' class="text-right"><?php echo $translations['A00651'][$language]; /* Grand Total */?>:</td>
