    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#submitBtn').click(function() {
               ...
               // var nameEN = $('#englishName').val();
               // var nameCNS = $('#chineseSimplifiedName').val();
               // var nameCNT = $('#chineseTraditionalName').val();

               // var nameLang = {
               //      english : nameEN,
               //      chineseSimplified : nameCNS,
               //      chineseTraditional : nameCNT
               // };

               // var ringDesignEN = $('#englishRingDesign').val();
               // var ringDesignCNS = $('#chineseSimplifiedRingDesign').val();
               // var ringDesignCNT = $('#chineseTraditionalRingDesign').val();

               // var ringDesignLang = {
               //      english : ringDesignEN,
               //      chineseSimplified : ringDesignCNS,
               //      chineseTraditional : ringDesignCNT
               // };

               // var materialEN = $('#englishMaterial').val();
               // var materialCNS = $('#chineseSimplifiedMaterial').val();
               // var materialCNT = $('#chineseTraditionalMaterial').val();

               // var materialLang = {
               //      english : materialEN,
               //      chineseSimplified : materialCNS,
               //      chineseTraditional : materialCNT
               // };
