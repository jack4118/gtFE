...
function ajaxSend(url, val, method, fCallback, debug, bypassBlocking, bypassLoading, importFlag) {
    ...
    if(debug) 
        console.log("url:"+url+" ## val:"+val+" ## method:"+method+" ## fCallback:"+fCallback.name+" ## debug:"+debug+" ## bypassBlocking:"+bypassBlocking+" ## ajaxBlocking:"+ajaxBlocking);
...
function errorHandler(errorCode, errorMsg) {
    switch(errorCode) {
        case 1:
            showMessage(errorMsg, "warning", "Error","file", "");
            break;
        case 2:
            showMessage(errorMsg, "danger", "Error","file", "");
            break;
        case 3:
