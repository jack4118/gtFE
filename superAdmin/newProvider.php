                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-box p-b-0">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <form role="form" id="newProvider" data-parsley-validate novalidate>
                                            <input type="hidden" name="command" value="newProvider">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="apiKey" type="text" class="form-control" name="apiKey">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="m-b-20" id="status">
                                                    <div class="radio radio-info radio-inline">
                                                        <input type="radio" id="inlineRadio1" value="0" name="providerStatus" checked>
                                                        <label for="inlineRadio1"> Active </label>
                                                    </div>
                                                    <div class="radio radio-inline">
                                                        <input type="radio" id="inlineRadio2" value="1" name="providerStatus" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="defaultSender" type="text" class="form-control" name="defaultSender">
                                            </div> 
                        ...
                        <div class="col-md-12 m-b-20">
                            <button id="addNewProvider" type="submit" class="btn btn-primary waves-effect waves-light">Confirm</button>
                        </div>
                    </div>
                    <!-- End row -->
                </div> <!-- container -->
...
<script>
    ...
    $(document).ready(function() {
        $('#addNewProvider').click(function() {
            var validate = $('#newProvider').parsley().validate();
            if(validate) {
                var formData = $('#newProvider').serialize();
    ...
    function sendNew(data, message) {
        showMessage('Provider successfully created.', 'success', 'Add New Provider', 'Provider', 'providers.php');
    }
</script>
</html>