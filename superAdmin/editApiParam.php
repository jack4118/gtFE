...
<?php include("head.php"); ?>
        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <form role="form" id="editApiParam" data-parsley-validate novalidate>
                            <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control"  required id="api_id" name="api_id">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="apiParamName" id="params_name">
                                                <ul class="parsley-errors-list filled" id="apiParamNameError" style="display: none;"><li class="parsley-required">Please enter api parameter name.</li></ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 card-box kanban-box">
                                            <div class="col-sm-12">
                                                <div class="radio radio-info radio-inline">
                                                    <input type="radio" id="alphaNumeric" value="alphanumeric" name="apiParamVal" checked="">
                                                    <label for="inlineRadio1"> Alphanumberic </label>
                                                </div>
                                                <div class="radio radio-info radio-inline">
                                                    <input type="radio" id="numeric" value="numeric" name="apiParamVal" checked="">
                                                    <label for="inlineRadio2"> Numeric </label>
                                                </div>
                                                <div class="radio radio-info radio-inline">
                                                    <input type="radio" id="blob" value="blob" name="apiParamVal" checked="">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            getApiName();
            getEditParamData();
            apiParamId = $.urlParam('id');
            $('#saveApiParam').click(function() {
                var validate = $('#editApiParam').parsley().validate();
                if(validate) {

                    var apiParamName = $('#params_name').val();
                    var apiParamVal = $("input[name='apiParamVal']:checked").val();
                    var apiID     = jQuery("#api_id option:selected").val();

                    if(apiID == '--Please Select--') {
                        apiID = "";
                    }

                    var formData = { 'command'      : "editParam", 
        ...
        function sendEdit(data, message) {
            showMessage('Api Parameter successfully updated.', 'success', 'Edit Api Parameter', 'ApiParam', 'apiList.php');
        }
    </script>
</html>
