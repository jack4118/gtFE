...
<?php include("head.php"); ?>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form id="searchSetting" role="form">
                                                <div class="col-sm-4 form-group">
                                                    ...
                                                    <input type="text" class="form-control" dataName="moduleName" dataType="text">
                                                </div>
                                                <!-- <div class="col-sm-4 form-group">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-box p-b-0">
                                <a href="addModuleSetting.php" type="button" class="btn btn-primary waves-effect w-md waves-light m-b-20">New Module Setting</a>
                                <form>
                                    <div id="basicwizard" class="pull-in">
                                        <div class="tab-content b-0 m-b-0 p-t-0">
                                            <div id="alertMsg" class="alert" style="display: none;"></div>
                                            <div id="moduleSettingListDiv" class="table-responsive"></div>
                                            <span id="paginateText"></span>
                                            <div class="text-center">
                                                <ul class="pagination pagination-md" id="pagerModuleSettingList"></ul>
                                            </div>
                                        </div>
                                    </div>
                                </form>
    ...
    <script>
        ...
        var divId = 'moduleSettingListDiv';
        var tableId = 'moduleSettingListTable';
        var pagerId = 'pagerModuleSettingList';
        ...
        var formData = {command: 'getModuleSettingList', pageNumber : pageNumber};
