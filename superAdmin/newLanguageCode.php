                                ...
                                <div class="row">
                                    <div id="form-fields-test-id" class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="content_code" type="text" class="form-control"  name="content_code"  required>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="Dynamic" disabled="true">
                                        </div>  
                                		<input type="hidden" class="form-control" value="Dynamic" name="category"> 
...
<script>
    ...
    function loadFormDropdown(data, message) {
        $.each(data.language, function(key, val) {
	        str = '<div class="form-group"><label for="">Content (' + val + ')</label><input id="'+ key +'" type="text" class="form-control" name="'+key+'"></div>';
	        $( "#form-fields-test-id" ).append(str);
    	});

        $.each(data.lastCode, function(key, val){
        	$('#content_code').append('<option value="'+val+'">'+val+'</option>'); 
        }); 

        
        // $('#content_code').val(data.lastMcode);
        // $('#lastCode1').val(data.lastAcode);
