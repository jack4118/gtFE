        ...
        <div class="content-page">
                                    ...
                                    <div class="panel-heading" role="tab" id="headingOne">
                                        <h4 class="panel-title">
                                            <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne" class="collapse">
                                                <?php echo "Search";//$translations['A00051'][$language]; /* Search */?>
                                            </a>
                                        </h4>
                                    </div>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="col-sm-12">
                                                <button id="searchLanguageCodeBtn" type="button" class="btn btn-primary waves-effect waves-light">
                                                    <?php echo "Search";//$translations['A00052'][$language]; /* Search */?>
                                                </button>
                                                <button id="resetLanguageCode" type="button" class="btn btn-default waves-effect waves-light">
                                                    <?php echo "Reset";//$translations['A00053'][$language]; /* Reset */?>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                	...
                	<a id="newLang" class="btn btn-primary waves-effect waves-light m-b-rem1" href="newLanguageCode.php">New Language</a>
                	<?php
                    ...
                    <div class="card-box p-b-0">
                    	<label id="lastEdit" style="color:red"></label>
                        <form>
...
<?php include("shareJs.php"); ?>
    ...
    <script>
        ...
        var btnArray = Array();
        var thArray = Array (
			//'<?php //echo $translations['A00332'][$language]; /* ID */?>',
             'Code', //'<?php //echo $translations['A00333'][$language]; /* Code */?>',
             'Site', //'<?php //echo $translations['A00336'][$language]; /* Site */?>',
             'Module', //'<?php //echo $translations['A00335'][$language]; /* Module */?>',
        ...
        function loadSearch(data, message) {
            ...
            $('#searchMsg').addClass('alert-success').html('<span>'+'<?php echo $translations['A00339'][$language]; /* Search successful. */?>'+'</span>').show();
            setTimeout(function() {
