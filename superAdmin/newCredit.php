                                    ...
                                    <form role="form" id="newCredit" data-parsley-validate novalidate>
                                        <div id="basicwizard" class=" pull-in">
                                            <div class="tab-content b-0 m-b-0 p-t-0">
                                                ...
                                                <div class="form-group" id="creditDisplay">
                                                    <label for="">Credit Display</label>
                                                </div>
                                                <div class="form-group">
...
<script>
    ...
    var fCallback = loadDefault;
    var formData = {command: 'getActiveLanguages'};
    $(document).ready(function() {
        ...
        $('#addNewCredit').click(function() {
            ...
            if(validate) {
                ...
                var creditDisplay = {};
                $('#creditDisplay input[name=creditLang]').each(function() {
                    creditDisplay[this.id] = this.value;
                });
    ...
    function loadDefault(data, message) {
        var creditLang = "";
        $.each(data, function(key, value){
            creditLang += '<input id="'+value+'" name="creditLang" type="text" placeholder="'+value+'" class="form-control" value=""><br>';
        });

        $("#creditDisplay").append(creditLang);
    }
